...
class Subtask(BaseModel):
    ...
    specialist: str = Field(description="Assigned specialist: 'researcher', 'coder', or 'writer'")
...
class AgentState(TypedDict):
    ...
    # Annotated with operator.add so completed tasks append to the list rather than overwrite it
